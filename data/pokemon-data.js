...
export const pokeDex = [

    {
        ...
        img: './data/pokeimg/musk-wario.png'
    },

    {
        ...
        name: 'Charizard',
        types: ['Fire', 'Flying'],
        moves: ['return', 'fireblast', 'hurricane', 'focusblast'],
...

    {
        ...
        name: 'Butterfree',
        types: ['Bug', 'Flying'],
        moves: ['bravebird', 'sludgewave', 'hurricane', 'quickattack'],
...

    {
        ...
        name: 'Beedrill',
        types: ['Bug', 'Poison'],
        moves: ['poisonjab', 'xscissor', 'drillrun', 'brickbreak'],
...

    {
        ...
        name: 'Pidgeot',
        types: ['Normal', 'Flying'],
        moves: ['doubleedge', 'hurricane', 'heatwave', 'steelwing'],
...

    {
        ...
        name: 'Arbok',
        types: ['Poison'],
        moves: ['poisonjab', 'aquatail', 'rockslide', 'suckerpunch'],
...

    {
        ...
        name: 'Pikachu',
        types: ['Electric'],
        moves: ['fakeout', 'extremespeed', 'voltswitch', 'surf'],
...

    {
        ...
        name: 'Nidoking',
        types: ['Poison', 'Ground'],
        moves: ['sludgewave', 'earthpower', 'thunderbolt', 'icebeam'],
...

    {
        ...
        name: 'Clefable',
        types: ['Fairy'],
        moves: ['moonblast', 'return', 'quickattack', 'knockoff'],
...

    {
        ...
        name: 'Wigglytuff',
        types: ['Normal', 'Fairy'],
        moves: ['moonblast', 'hypervoice', 'blizzard', 'slackoff'],
...

    {
        ...
        name: 'Parasect',
        types: ['Bug', 'Grass'],
        moves: ['seedbomb', 'xscissor', 'throatchop', 'brickbreak'],
...

    {
        ...
        name: 'Persian',
        types: ['Normal'],
        moves: ['fakeout', 'doubleedge', 'knockoff', 'uturn'],
...

    {
        ...
        name: 'Golduck',
        types: ['Water'],
        moves: ['hydropump', 'icebeam', 'psychic', 'focusblast'],
...

    {
        ...
        name: 'Primeape',
        types: ['Fighting'],
        moves: ['crosschop', 'gunkshot', 'seedbomb', 'icepunch'],
...

    {
        ...
        moves: ['waterfall', 'closecombat', 'icepunch', 'earthquake'],
...

    {
        ...
        name: 'Machamp',
        types: ['Fighting'],
        moves: ['closecombat', 'knockoff', 'heavyslam', 'bulletpunch'],
...

    {
        ...
        name: 'Tentacruel',
        types: ['Water', 'Poison'],
        moves: ['scald', 'sludgebomb', 'knockoff', 'rapidspin'],
...

    {
        ...
        name: 'Golem',
        types: ['Rock', 'Ground'],
        moves: ['rockslide', 'earthquake', 'firepunch', 'thunderpunch'],
...

    {
        ...
        name: 'Slowbro',
        types: ['Water', 'Psychic'],
        moves: ['scald', 'icebeam', 'slackoff', 'quickattack'],
...

    {
        ...
        name: 'Muk',
        types: ['Poison'],
        moves: ['gunkshot', 'icepunch', 'shadowsneak', 'firepunch'],
    ...
    
    {
        ...
        name: 'Onyx',
        types: ['Rock', 'Ground'],
        moves: ['earthquake', 'rockblast', 'quickattack', 'rockslide'],
...

    {
        ...
        name: 'Exeggutor',
        types: ['Grass', 'Psychic'],
        moves: ['quickattack', 'leafstorm', 'earthquake', 'psychic'],
...

    {
        ...
        name: 'Marowak',
        types: ['Ground'],
        moves: ['closecombat', 'earthquake', 'knockoff', 'firepunch'],
...

    {
        ...
        name: 'Hitmonchan',
        types: ['Fighting'],
        moves: ['rapidspin', 'drainpunch', 'throatchop', 'machpunch'],
...

    {
        ...
        name: 'Weezing',
        types: ['Poison'],
        moves: ['sludgebomb', 'fireblast', 'thunderbolt', 'psychic'],
...

    {
        ...
        name: 'Seadra',
        types: ['Water'],
        moves: ['surf', 'scald', 'hydropump', 'icebeam'],
...

    {
        ...
        name: 'Seaking',
        types: ['Water'],
        moves: ['waterfall', 'knockoff', 'megahorn', 'flipturn'],
...

    {
        ...
        name: 'Starmie',
        types: ['Water', 'Psychic'],
        moves: ['hydropump', 'thunderbolt', 'icebeam', 'psyshock'],
    ...
    
    {
        ...
        name: 'Magmar',
        types: ['Fire'],
        moves: ['lavaplume', 'scorchingsands', 'fireblast', 'focusblast'],
...

    {
        ...
        name: 'Tauros',
        types: ['Normal'],
        moves: ['bodyslam', 'closecombat', 'throatchop', 'ironhead'],
...

    {
        ...
        name: 'Jolteon',
        types: ['Electric'],
        moves: ['thunderbolt', 'voltswitch', 'shadowball' ,'quickattack'],
...

    {
        ...
        name: 'Porygon',
        types: ['Normal'],
        moves: ['triattack', 'psychic', 'icebeam', 'quickattack'],
...

    {
        ...
        name: 'Omastar',
        types: ['Rock', 'Water'],
        moves: ['quickattack', 'meteorbeam', 'surf', 'icebeam'],
...

    {
        ...
        name: 'Aerodactyl',
        types: ['Rock', 'Flying'],
        moves: ['stoneedge', 'dualwingbeat', 'earthquake', 'crunch'],
...

    {
        ...
        name: 'Snorlax',
        types: ['Normal'],
        moves: ['closecombat', 'bodyslam', 'earthquake', 'crunch'],
...

    {
        ...
        name: 'Articuno',
        types: ['Ice', 'Flying'],
        moves: ['return', 'quickattack', 'iciclecrash', 'bravebird'],
...

    {
        ...
        moves: ['return', 'heatwave', 'discharge', 'hurricane'],
...

    {
        ...
        name: 'Moltres',
        types: ['Fire', 'Flying'],
        moves: ['flamethrower', 'return', 'scorchingsands', 'hurricane'],
...

    {
        ...
        name: 'Dragonite',
        types: ['Dragon', 'Flying'],
        moves: ['icebeam', 'earthquake', 'return', 'extremespeed'],
...

    {
        ...
        name: 'Mewtwo',
        types: ['Psychic'],
        moves: ['psystrike', 'icebeam', 'fireblast', 'shadowball'],
...

    {
        ...
        name: 'Mew',
        types: ['Psychic'],
        moves: ['quickattack', 'knockoff', 'psychic', 'return'],
